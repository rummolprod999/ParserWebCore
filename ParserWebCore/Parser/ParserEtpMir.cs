...
{
    public class ParserEtpMir : ParserAbstract, IParser
    {
        ...
        {
            var url =
                $"https://torgi.etp-mir.ru/searchServlet?query=%7B%22types%22%3A%5B%22BUYING%22%2C%22SALE%22%2C%22RFI%22%2C%22SMALL_PURCHASE%22%5D%7D&filter=%7B%22state%22%3A%5B%22ALL%22%5D%7D&sort=%7B%22placementDate%22%3Afalse%7D&limit=%7B%22min%22%3A{num}%2C+%22max%22%3A{num + 20}%2C+%22updateTotalCount%22%3Atrue%7DD";
        ...
        private void ParserTenderObj(JToken t)
        {
            ...
            ParserTender(new TenderEtpMir("Электронная торговая площадка МИР", "https://torgi.etp-mir.ru/", 397,
                tender));
        }
    }
}
    ...
    public class TenderAbsGroup : TenderAbstract, ITender
    {
        ...
        public void ParsingTender()
        {
            using (var connect = ConnectToDb.GetDbConnection())
            {
                ...
                var cancelStatus = 0;
                var updated = false;
                updated = UpdateTenderDate(connect, updated, dateUpd, ref cancelStatus);
                ...
                PlacingWay = (navigator
                    .SelectSingleNode(
                        "//div[. = 'Вид тендера']/following-sibling::div")
                    ?.Value ?? "").Trim();
        ...
        private static void AddDocs(HtmlDocument htmlDoc, MySqlConnection connect, int idTender)
        {
            ...
            foreach (var doc in docs)
            {
                ...
                var urlAtt = $"https://tender.absgroup.ru{urlAttT}";
        ...
        private bool UpdateTenderDate(MySqlConnection connect, bool updated, DateTime dateUpd, ref int cancelStatus)
        {
            var selectDateT =

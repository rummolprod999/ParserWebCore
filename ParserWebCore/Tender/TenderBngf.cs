...
{
    public class TenderBngf : TenderAbstract, ITender
    {
        private readonly TypeBnGf _tn;

        public TenderBngf(string etpName, string etpUrl, int typeFz, TypeBnGf tn) : base(etpName, etpUrl,
            typeFz)
        {
            _tn = tn;
        }

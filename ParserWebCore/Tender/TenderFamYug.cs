...
{
    public class TenderFamYug : TenderAbstract, ITender
    {
        private readonly ChromeDriver _driver;
        private readonly TypeFamYug _tn;

        public TenderFamYug(string etpName, string etpUrl, int typeFz, TypeFamYug tn, ChromeDriver driver)
            : base(etpName, etpUrl,
                typeFz)
        {
            _tn = tn;

...
{
    public class TenderGipVn : TenderAbstract, ITender
    {
        private readonly TypeGipVn _tn;

        public TenderGipVn(string etpName, string etpUrl, int typeFz, TypeGipVn tn) : base(etpName, etpUrl,
            typeFz)
        {
            _tn = tn;
        }
        ...
        public void ParsingTender()
        {
            using (var connect = ConnectToDb.GetDbConnection())
            {
                ...
                cmd9.Parameters.AddWithValue("@href", EtpUrl);
                ...
                cmd9.Parameters.AddWithValue("@xml", EtpUrl);
                ...
                cmd10.Parameters.AddWithValue("@file_name", "Пакет документов");

...
{
    public class TenderKzGroup : TenderAbstract, ITender
    {
        private readonly TypeKzGroup _tn;

        public TenderKzGroup(string etpName, string etpUrl, int typeFz, TypeKzGroup tn) : base(etpName, etpUrl,
            typeFz)
        {
            _tn = tn;
        }

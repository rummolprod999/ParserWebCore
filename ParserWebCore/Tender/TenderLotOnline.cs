...
{
    public class TenderLotOnline : TenderAbstract, ITender
    {
        private readonly TypeLotOnline _tn;
        ...
        public void ParsingTender()
        {
            using (var connect = ConnectToDb.GetDbConnection())
            {
                ...
                {
                    s = DownloadString.DownLHttpPost(_tn.Href.Replace(
                        "https://market.lot-online.ru/etp/app/LotCard/page?LotCard.lotEntity=",
        ...
        private void AddAttachments(HtmlDocument htmlDoc, MySqlConnection connect, int idTender)
        {
            ...
            foreach (var doc in docs)
            {
                ...
                var urlAtt = $"https://market.lot-online.ru{urlAttT}";

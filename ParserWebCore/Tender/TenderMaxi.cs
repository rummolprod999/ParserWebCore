...
{
    public class TenderMaxi : TenderAbstract, ITender

    {
        private readonly TypeMaxi _tn;

        public TenderMaxi(string etpName, string etpUrl, int typeFz, TypeMaxi tn) : base(etpName, etpUrl,
            typeFz)
        {
            _tn = tn;
        }
        ...
        public void ParsingTender()
        {
            using (var connect = ConnectToDb.GetDbConnection())
            {
                ...
                if (!string.IsNullOrEmpty(orgName))
                {
                    ...
                    {
                        var phone = "(8172)266-550";
                        var email = "";
                        var inn = "352500101378";
                        var kpp = "";
                        var contactPerson = "";
                        var addOrganizer =
                ...
                if (!string.IsNullOrEmpty(orgName))
                {
                    ...
                    else
                    {
                        ...
                        cmd14.Parameters.AddWithValue("@inn", "352500101378");

...
{
    public class TenderRcs : TenderAbstract, ITender
    {
        private readonly TypeRcs _tn;

        public TenderRcs(string etpName, string etpUrl, int typeFz, TypeRcs tn) : base(etpName, etpUrl,
            typeFz)
        {
            _tn = tn;
        }

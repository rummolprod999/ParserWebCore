...
{
    public class TenderRusfish : TenderAbstract, ITender
    {
        private readonly TypeRusfish _tn;

        public TenderRusfish(string etpName, string etpUrl, int typeFz, TypeRusfish tn) : base(etpName, etpUrl,
            typeFz)
        {
            _tn = tn;
        }
        ...
        public void ParsingTender()
        {
            using (var connect = ConnectToDb.GetDbConnection())
            {
                ...
                foreach (var doc in docs)
                {
                    ...
                    var urlAtt = $"https://russianfishery.ru{urlAttT}";

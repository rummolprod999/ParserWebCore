...
{
    public class TenderSetOnline : TenderAbstract, ITender
    {
        private readonly TypeSetOnline _tn;

        public TenderSetOnline(string etpName, string etpUrl, int typeFz, TypeSetOnline tn) : base(etpName, etpUrl,
            typeFz)
        {
            _tn = tn;

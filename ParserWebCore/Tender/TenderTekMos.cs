...
{
    public class TenderTekMos : TenderAbstract, ITender
    {
        private readonly TypeTekMos _tn;

        public TenderTekMos(string etpName, string etpUrl, int typeFz, TypeTekMos tn) : base(etpName, etpUrl,
            typeFz)
        {
            _tn = tn;
        }

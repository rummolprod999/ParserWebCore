...
{
    public class TenderTekSil : TenderAbstract, ITender
    {
        private readonly TypeTekSil _tn;

        public TenderTekSil(string etpName, string etpUrl, int typeFz, TypeTekSil tn) : base(etpName, etpUrl,
            typeFz)
        {
            _tn = tn;
        }

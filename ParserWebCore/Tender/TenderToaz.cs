...
{
    public class TenderToaz : TenderAbstract, ITender
    {
        private readonly TypeToaz _tn;

        public TenderToaz(string etpName, string etpUrl, int typeFz, TypeToaz tn) : base(etpName, etpUrl,
            typeFz)
        {
            _tn = tn;
        }

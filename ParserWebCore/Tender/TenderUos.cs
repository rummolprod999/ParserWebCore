...
{
    public class TenderUos : TenderAbstract, ITender
    {
        private readonly TypeUos _tn;

        public TenderUos(string etpName, string etpUrl, int typeFz, TypeUos tn) : base(etpName, etpUrl,
            typeFz)
        {
            _tn = tn;
        }

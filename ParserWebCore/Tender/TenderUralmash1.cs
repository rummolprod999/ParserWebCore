...
{
    public class TenderUralmash1 : TenderAbstract, ITender
    {
        private readonly TypeUral1 _tn;

        public TenderUralmash1(string etpName, string etpUrl, int typeFz, TypeUral1 tn) : base(etpName, etpUrl,
            typeFz)
        {
            _tn = tn;
        ...
        public void ParsingTender()
        {
            using (var connect = ConnectToDb.GetDbConnection())
            {
                ...
                cmd9.Parameters.AddWithValue("@scoring_date", _tn.DateScoring);

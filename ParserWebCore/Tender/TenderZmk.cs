...
{
    public class TenderZmk : TenderAbstract, ITender
    {
        private readonly TypeZmk _tn;

        public TenderZmk(string etpName, string etpUrl, int typeFz, TypeZmk tn) : base(etpName, etpUrl,
            typeFz)
        {
            _tn = tn;
        }
